...
### 33. {TitleComponent} vs {<TitleComponent />} vs {<TitleComponent></TitleComponent>} in JSX
...
### 39. Why we need keys in React ? When do we need keys in React ?
...
### 40. Can we use index as keys in React ?
...
### 41. What is props in React ? Ways to
...
### 43. What is the difference between Named export, Default export and \* as export?
...
### 46. Why do we need a useState hooks?
...
### 48. What is Monolith architecture?
...
### 49. What is the difference between Monolith and Microservice?
...
### 69. When do we and why do we need suspense?
...
### 71. What is lifting the state up?
...
### 72. What are Context Provider and Context Consumer?
...
### 73. If you don't pass a value to the provider does it take the default value?
